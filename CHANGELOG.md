...
## 1.3.5 (2026-09-16)
- **Settings scroll:** Settings tab scrolls to the bottom again (Save / Reset always reachable)
- **Popup build:** Removed unused Vite `modulepreload` links that caused Chrome/Vivaldi extension warnings
